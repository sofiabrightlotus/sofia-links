...
const I18N = {
  en: {
    ...
    workedWithText: "I've worked with COSNORI, iUNIK, and Kelowna Baskets, creating unique content.",
  ...
  fr: {
    ...
    workedWithText: "J'ai collaboré avec COSNORI, iUNIK et Kelowna Baskets pour créer du contenu unique.",
...
const ICONS = {
  ...
  threads: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M12 2C7 2 4 5.5 4 10.5c0 3 1.3 5 3 6.3M12 2c5 0 8 3.5 8 8.5 0 7-4 11.5-9 11.5-3 0-5-1.5-5-4 0-3 3-4 6-4 3.5 0 6 1.5 6 4.5"/></svg>',
